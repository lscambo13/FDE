...
$B echo "net.ipv4.tcp_keepalive_intvl=18" >> /system/etc/sysctl.conf
$B echo "net.ipv4.tcp_keepalive_probes=6" >> /system/etc/sysctl.conf
$B echo "net.ipv4.tcp_fin_timeout=15" >> /system/etc/sysctl.conf
...
$B sysctl -e -w net.ipv4.tcp_keepalive_intvl=18
$B sysctl -e -w net.ipv4.tcp_keepalive_probes=6
$B sysctl -e -w net.ipv4.tcp_fin_timeout=15
