...
if [ -e /system/engine/prop/firstboot ]; then
 ...
 if [ -e /system/xbin/sqlite3 ]; then
  $B echo "REPLACE INTO \"system\" VALUES(26,'window_animation_scale','0');REPLACE INTO \"system\" VALUES(27,'transition_animation_scale','0');" | sqlite3 /data/data/com.android.providers.settings/databases/settings.db;
 fi;
 content update --uri content://settings/system --bind value:s:0 --where 'name="window_animation_scale"';
 content update --uri content://settings/system --bind value:s:0 --where 'name="transition_animation_scale"';
